...
(function(e) {
    e.fn.notifyMe = function() {
        ...
        // Alert messages
        var thvalid        = '<p class="notify-valid"><i class="icon ion-checkmark-round"></i> Congrats! You are in list. We will inform you as soon as we finish.</p>';
        var thproblem      = '<p class="notify-valid"><i class="icon ion-close-round"></i> Your e-mail address is incorrect. Please check it and try again.</p>';
        var thoops         = '<p class="notify-valid"><i class="icon ion-close-round"></i> Oops. Looks like something went wrong. Please try again later.</p>';
        var thfake         = '<p class="notify-valid"><i class="icon ion-close-round"></i> This email address looks fake or invalid. Please enter a real email address.</p>';
        var thavailability = '<p class="notify-valid"><i class="icon ion-close-round"></i> Service is not available at the moment. Please check your internet connection or try again later.</p>';
